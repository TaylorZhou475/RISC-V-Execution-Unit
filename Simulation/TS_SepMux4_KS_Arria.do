...
transcript file "../Documentation/OutputFiles/TS_SepMux4_KS_Arria.log"
transcript off
...
vcom -work work -2008 -quiet -stats=none ../Simulation/ModelSim/SepMux4_KS_Arria.vho
...
vsim -quiet -t 100ps -gui -GTIMING_MEASUREMENT=true -sdftyp /ExecUnitTB/DUT=../Simulation/ModelSim/SepMux4_KS_Arria.sdo work.Config_SepMux4_KS_Timing
