...
transcript file "../Documentation/OutputFiles/FS_ExecUnit_KS.log"
transcript off
...
vcom -work work -2008 -quiet -stats=none "../SourceCode/ConfigExecUnit_KS.vhd"

#Starts the simulation
vsim -quiet -GTIMING_MEASUREMENT=false work.ConfigExecUnit_KS
