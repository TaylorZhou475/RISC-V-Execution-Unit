...
transcript file "../Documentation/OutputFiles/TS_CombMux4_CondS_Cyclone.log"
transcript off
...
vcom -work work -2008 -quiet -stats=none ../Simulation/ModelSim/CombMux4_CondS_Cyclone.vho
...
vsim -quiet -t 100ps -gui -GTIMING_MEASUREMENT=true -sdftyp /ExecUnitTB/DUT=../Simulation/ModelSim/CombMux4_CondS_Cyclone.sdo work.Config_CombMux4_CondS_Timing
