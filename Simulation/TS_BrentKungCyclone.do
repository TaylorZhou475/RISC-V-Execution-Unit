...
# Start transcript
transcript file "../Documentation/OutputFiles/TS_BrentKungCyclone.log"
transcript off
...
#Compile vho file
vcom -work work -2008 -quiet -stats=none ../Simulation/ModelSim/BrentKung_Cyclone.vho
...
vsim -quiet -t 100ps -gui -GTIMING_MEASUREMENT=true -sdftyp /AdderTB/DUT=../Simulation/ModelSim/BrentKung_Cyclone.sdo work.ConfigBKA_structure
