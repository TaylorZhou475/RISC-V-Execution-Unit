...
# Start transcript
transcript file "../Documentation/OutputFiles/TS_RippleCarryCyclone.log"
transcript off
...
#Compile vho file
vcom -work work -2008 -quiet -stats=none ../Simulation/ModelSim/RippleCarry_Cyclone.vho
...
vsim -quiet -t 100ps -gui -GTIMING_MEASUREMENT=true -sdftyp /AdderTB/DUT=../Simulation/ModelSim/RippleCarry_Cyclone.sdo work.ConfigRCA_structure
