...
transcript file "../Documentation/OutputFiles/TS_CombMux2_KS_Cyclone.log"
transcript off
...
vcom -work work -2008 -quiet -stats=none ../Simulation/ModelSim/CombMux2_KS_Cyclone.vho
...
vsim -quiet -t 100ps -gui -GTIMING_MEASUREMENT=true -sdftyp /ExecUnitTB/DUT=../Simulation/ModelSim/CombMux2_KS_Cyclone.sdo work.Config_CombMux2_KS_Timing
