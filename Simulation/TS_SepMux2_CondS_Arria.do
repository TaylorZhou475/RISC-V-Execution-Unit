...
transcript file "../Documentation/OutputFiles/TS_SepMux2_CondS_Arria.log"
transcript off
...
vcom -work work -2008 -quiet -stats=none ../Simulation/ModelSim/SepMux2_CondS_Arria.vho
...
vsim -quiet -t 100ps -gui -GTIMING_MEASUREMENT=true -sdftyp /ExecUnitTB/DUT=../Simulation/ModelSim/SepMux2_CondS_Arria.sdo work.Config_SepMux2_CondS_Timing
