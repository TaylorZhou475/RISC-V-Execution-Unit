...
# Start transcript
transcript file "../Documentation/OutputFiles/TS_LadnerFischerCyclone.log"
transcript off
...
#Compile vho file
vcom -work work -2008 -quiet -stats=none ../Simulation/ModelSim/LadnerFischer_Cyclone.vho
...
vsim -quiet -t 100ps -gui -GTIMING_MEASUREMENT=true -sdftyp /AdderTB/DUT=../Simulation/ModelSim/LadnerFischer_Cyclone.sdo work.ConfigLFA_structure
