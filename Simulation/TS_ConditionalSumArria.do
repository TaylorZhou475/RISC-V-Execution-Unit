...
# Start transcript
transcript file "../Documentation/OutputFiles/TS_ConditionalSumArria.log"
transcript off
...
#Compile vho file
vcom -work work -2008 -quiet -stats=none ../Simulation/ModelSim/ConditionalSum_Arria.vho
...
vsim -quiet -t 100ps -gui -GTIMING_MEASUREMENT=true -sdftyp /AdderTB/DUT=../Simulation/ModelSim/ConditionalSum_Arria.sdo work.ConfigCSA_structure
