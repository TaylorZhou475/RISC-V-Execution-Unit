...
transcript file "../Documentation/OutputFiles/FS_ExecUnit_CS.log"
transcript off
...
vcom -work work -2008 -quiet -stats=none "../SourceCode/ConfigExecUnit_CS.vhd"

#Starts the simulation
vsim -quiet -GTIMING_MEASUREMENT=false work.ConfigExecUnit_CS
